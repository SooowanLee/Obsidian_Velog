...
### 40 추가
7, 15와 비교, 30보다 크고 70보다 작기 때문에 40, 50 ,60이 됩니다. 노드가 넘치기 때문에 분할을 합니다. 60이 저장될 노드가 만들어지고 50은 올라갑니다. 그럼 30, 50, 70이기 때문에 또 분할됩니다. 70이 저장될 노드가 생성이 되고 40은 올라가게 됩니다. 여기서 7, 15, 40이 되기 때문에 root노드가 생성이 됩니다.15는 root노드에 올라가고 40은 분할된 root노드의 오른쪽 노드가 됩니다.
